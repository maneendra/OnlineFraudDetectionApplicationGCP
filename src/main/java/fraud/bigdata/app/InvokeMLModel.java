...
public class InvokeMLModel extends PTransform<PCollection<TransactionStatus>, PCollection<TransactionStatus>>{
	...
	public PCollection<TransactionStatus> expand(PCollection<TransactionStatus> input) {
		return input.apply(ParDo.of(new InvokeMLModelFn()));
	}
